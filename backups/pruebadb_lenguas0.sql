...
--
-- Host: 127.0.0.1    Database: pruebadb
-- ------------------------------------------------------
...
CREATE TABLE `lenguas` (
  ...
  `comunidad` varchar(15) DEFAULT NULL,
...
-- Dump completed on 2024-09-06 11:47:36
