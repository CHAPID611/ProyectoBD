...
CREATE TABLE `contribuciones` (
  ...
  `id_lengua` int DEFAULT NULL,
  `descripcion` tinytext,
  `fecha_contribucion` datetime DEFAULT NULL,
  PRIMARY KEY (`id_contribucion`),
  KEY `id_usuario` (`id_usuario`),
  KEY `id_lengua` (`id_lengua`),
  CONSTRAINT `contribuciones_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `contribuciones_ibfk_2` FOREIGN KEY (`id_lengua`) REFERENCES `lenguas` (`id_lengua`)
